...
const TestHelper = {
  ...
  checkKeys: function checkKeys(response, expected, allow, ordered) {
    ...
    for (let key in exp) {
      ...
      if (expected[exp[key]] instanceof Array) {
        ...
        if (objectInArray) {
          nestedCheck = TestHelper.isArrayOfJsonObjectsProperSubsetOf(
            response[exp[key]],
            expected[exp[key]],
            false,
            allow,
          ...
          nestedCheck = TestHelper.isListProperSubsetOf(
            response[exp[key]],
            expected[exp[key]],
            allow,
            ordered
   ...
   */
  isProperSubsetOf: function isProperSubsetOf(
    leftTree,
    rightTree,
    checkValues,
    allowExtra,
   ...
   */
  isJsonObjectProperSubsetOf: function isJsonObjectProperSubsetOf(
    leftObject,
    rightObject,
    checkValues,
    allowExtra,
    ...
    return TestHelper.isProperSubsetOf(
      JSON.stringify(leftObject),
      JSON.stringify(rightObject),
      checkValues,
      allowExtra,
      isOrdered
    );
   ...
   */
  isArrayOfStringifiedJsonObjectsProperSubsetOf:
    function isArrayOfStringifiedJsonObjectsProperSubsetOf(
      leftObject,
      rightObject,
      checkValues,
      allowExtra,
      ...
      return TestHelper.isArrayOfJsonObjectsProperSubsetOf(
        left,
        right,
        checkValues,
        allowExtra,
   ...
   * @return  {boolean}                True if it is a subset
   */
  isArrayOfJsonObjectsProperSubsetOf:
    function isArrayOfJsonObjectsProperSubsetOf(
      left,
      right,
      checkValues,
      allowExtra,
   ...
   */
  isListProperSubsetOf: function isListProperSubsetOf(
    leftList,
    rightList,
    allowExtra,
    isOrdered
   ...
   * @return {boolean}                 True if leftTree is a subset of rightTree
   */
  areHeadersProperSubsetOf: function areHeadersProperSubsetOf(
    leftTree,
    rightTree,
    checkValues
  ) {
    ...
    return (
      TestHelper.isProperSubsetOf(left, right, checkValues, true, false) ||
      TestHelper.isProperSubsetOf(right, left, checkValues, true, false)
    );
  },
